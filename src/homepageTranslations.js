const homepageTranslations = {
  en: {
    ...
    pageSeo: {
      ...
      routes: { title: "Tokyo 23-Ward Airport Fares & Private Routes in Japan" },
    ...
    routes: {
      ...
      tokyoWards: {
        ...
        subtitle:
          "One-way reference fares from Haneda (HND) or Narita (NRT) to each of Tokyo’s 23 special wards. Choose your airport, then confirm the exact hotel or address for a locked quote.",
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          answer:
            "For Tokyo airport transfers, start with the 23-ward reference table on the Routes page. Your final quote is based on the route, date, expected service time, vehicle category, group and luggage needs, planned stops and any special requests.",
        },
        {
  ...
  "zh-hk": {
    ...
    pageSeo: {
      ...
      routes: { title: "東京 23 區機場接送價目及日本包車路線" },
    ...
    routes: {
      ...
      tokyoWards: {
        ...
        subtitle:
          "羽田（HND）或成田（NRT）單程至東京 23 區的日圓參考價。先選機場，再提供酒店或詳細地址，我們會為您確認最終報價。",
        airportLabel: "機場",
        hndLabel: "羽田機場（HND）",
        nrtLabel: "成田機場（NRT）",
        sortLabel: "排序",
    ...
    faq: {
      ...
      items: [
        ...
        { question: "服務價格如何計算？", answer: "東京 23 區機場接送可先參考路線頁的分區日圓價表。最終報價會按路線、日期、預計用車時間、車型、同行人數、行李、停靠點及特別需要計算。" },
  ...
  ar: {
    ...
    pageSeo: {
      ...
      routes: { title: "أسعار مطار طوكيو حسب الأحياء الـ 23 ومسارات خاصة" },
    ...
    routes: {
      ...
      tokyoWards: {
        ...
        subtitle:
          "أسعار استرشادية ذهاب فقط من هانيدا (HND) أو ناريتا (NRT) إلى كل حي من أحياء طوكيو الـ 23. اختر المطار ثم أكد الفندق أو العنوان الدقيق لسعر نهائي.",
        airportLabel: "المطار",
        hndLabel: "هانيدا (HND)",
        nrtLabel: "ناريتا (NRT)",
        sortLabel: "ترتيب",
    ...
    faq: {
      ...
      items: [
        ...
        { question: "كيف يتم احتساب السعر؟", answer: "لنقل المطار إلى أحياء طوكيو الـ 23 يمكنك الاطلاع أولاً على جدول الأسعار الاسترشادي في صفحة المسارات. يعتمد العرض النهائي على المسار والتاريخ ومدة الخدمة وفئة المركبة وعدد المسافرين والأمتعة والمحطات وأي طلبات خاصة." },
